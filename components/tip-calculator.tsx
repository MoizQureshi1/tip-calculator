...
export default function TipCalculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-5 md:px-0 min-h-screen bg-gradient-to-r from-blue-400 via-sky-800 to-blue-600 dark:bg-gray-900">
      <Card className="w-full max-w-md p-6 bg-blue-100 dark:bg-gray-800 shadow-lg rounded-lg">
        <CardHeader>
